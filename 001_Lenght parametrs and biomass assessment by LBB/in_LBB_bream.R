...
# and derived reference points F/M, Z/K, Lopt, Lc_opt, B/B0, B/Bmsy, Y/R
...
getwd()
setwd("C:/Users/user/Desktop/2018froese/guide")
...
plot.year <- function(r.L.y,r.Freq.y,r.Lopt, SL1, SL2, MK, FK, Linf) {
 ...
 for(p in 2:length(r.L.y)) {
   ...
   } else {SL[p]  <- 1/(1+exp(-SL2*(r.L.y[p]-SL1/Linf)))}
